...
def check_arguments():
    ...
    if arguments_length > 2 or arguments_length < 2 or arguments_length == 0:
        ...
        print("Usage: drain_topic.py <bootstrap-servers> <topic_name>")
        print('Example: drain_topic.py "localhost:9098" alter_snaplogic_feed')
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    try:
        drain_topic(bootstrap_servers,topic_name)
    except Exception as e:
        print("Error draining topic. {}".format(e))